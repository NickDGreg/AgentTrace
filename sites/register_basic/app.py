...
app = Flask(__name__)
app.secret_key = "agenttrace-register-basic"
...
def index() -> str:
    ...
    <p><a href="/register"><button type="button">Register</button></a></p>
...
def register() -> str:
    ...
    <form method="post" action="/register" id="register-form">
      ...
      <label>Password <input type="password" name="password" id="password" required minlength="1"></label><br>
      <label>Confirm Password <input type="password" name="password_confirm" id="password_confirm" required minlength="1"></label><br>
...
def register_post():
    ...
    # Simulate successful registration (fake API response)
    return """
    <h1>Thank You!</h1>
    <p>Registration successful. Your account has been created.</p>
    <div id="api-response">
      <h2>API Response</h2>
      <pre>{"status": "success", "message": "User registered successfully", "user_id": "fake-uuid-12345"}</pre>
    </div>
